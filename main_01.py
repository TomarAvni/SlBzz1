...
def main():
    ...
    logger = GoogleSheetLogger(
        credentials_file="new_credentials_file.json",  # Replace with your new credentials file
        sheet_name='New_Sheet_Name'  # Replace with your new sheet name
    )
    ...
    while True:
        ...
        if 6 <= current_hour < 20:
            if current_minute % 2 == 1 and current_second == 20:
                try:
                    # Log data
                ...
                time_until_action = 20 - current_second if current_second < 20 else 80 - current_second
                print(f"Not the right time. Time left: {time_until_action} seconds")
        else:
